 ...
 class Usuario extends Conexion {
      ...
      public function addUsuario($correo, $password, $nombre,$rol)
	  {
      	parent::conectar();
            ...
            parent::query('insert into usuario(usuario, passwordUsuario, nombreUsuario,rolUsuario,DocumentosPersonal_idDocumentosPersonal) values("'.$correo.'", "'.$password.'","'.$nombre.'", "'.$rol.'", "1")');
      ...
      parent::query("DELETE FROM usuario WHERE id='$id'");
   ...
   public function login($user, $clave)
    {
      ...
      */
      ...
      // traemos el id y el nombre de la tabla usuarios donde el usuario sea igual al usuario ingresado y ademas la clave sea igual a la ingresada para ese usuario.
       $consulta = 'select idUsuario, nombreUsuario, rolUsuario, infoCompleta from usuario where usuario="'.$user.'" and passwordUsuario= MD5("'.$clave.'")';
      /*
