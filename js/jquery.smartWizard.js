...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        theme: 'circles', // theme for the wizard, related css need to include for other than default theme
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
           ...
           var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text(this.options.lang.next).addClass('btn btn-secondary sw-btn-next').attr('type', 'button').attr('style','margin-left:10px;') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text(this.options.lang.previous).addClass('btn btn-secondary sw-btn-prev').attr('type', 'button').attr('style','margin-left:950px;') : null;
