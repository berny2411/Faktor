$(function(){
   ...
   */
   ...
   var num=1;
  $('#drag-and-drop-zoneCartaAP').dmUploader({ //
    url: 'controller/uploadC.php',
    multiple:false,
...
$(function(){
   ...
   */
   var num=2;
  $('#drag-and-drop-zoneFacHPDf').dmUploader({ //
    url: 'controller/uploadC.php',
    multiple:false,
    maxFileSize: 3000000, // 3 Megs 
    allowedTypes: 'application/pdf',
...
$(function(){
   ...
   */
   var num=3;
  $('#drag-and-drop-zoneFacHXML').dmUploader({ //
    url: 'controller/uploadC.php',
    multiple:false,
    maxFileSize: 3000000, // 3 Megs 
 ...
 $('#btnApiStart').on('click', function(evt){
    ...
    $('#drag-and-drop-zoneCartaAP').dmUploader('start');
    $('#drag-and-drop-zoneFacHPDf').dmUploader('start');
    $('#drag-and-drop-zoneFacHXML').dmUploader('start');
    $('#btnFinalizarCaso').removeAttr("disabled");
  });
...
$('#files').on('click', 'button.cancel', function(evt){
    ...
    $('#drag-and-drop-zoneCartaAP').dmUploader('cancel', id);
    $('#drag-and-drop-zoneFacHPDf').dmUploader('cancel', id2);
    $('#drag-and-drop-zoneFacHXML').dmUploader('cancel', id3);
