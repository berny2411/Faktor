                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-home-tab3" data-toggle="pill" href="#pills-home3" role="tab" aria-controls="pills-home" aria-selected="true">Datos Personales</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab2" data-toggle="pill" href="#pills-profile2" role="tab" aria-controls="pills-profile" aria-selected="false">Datos Bancarios</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tabmedAS" data-toggle="pill" href="#pills-medAs" role="tab" aria-controls="pills-profile" aria-selected="false">Medico-Aseguradora</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-contact-tab2" data-toggle="pill" href="#pills-contact2" role="tab" aria-controls="pills-contact" aria-selected="false">Documentos Personales</a>
                            </li>
                        </ul>
                                ...
                                <form id="altaMedico1">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text"  name="apellidoPat" placeholder="Ingrese apellidoPat" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-key"></i></div>
                                            <input type="text"  name="apellidoMat" placeholder="Ingrese apellidoMat" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                    ...
                                    <div class="form-actions form-group"><button type="button" class="btn btn-primary btn-block" id="altaMedico">Submit</button></div>
                            ...
                            <div class="tab-pane fade" id="pills-profile2" role="tabpanel" aria-labelledby="pills-profile-tab">
                                <form id="altaMedico2">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-envelope"></i></div>
                                            <input type="text" name="folioFiscal" placeholder="Folio Fiscal" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                    ...
                                    <div class="form-actions form-group"><button type="button" class="btn btn-primary btn-block" id="altaMedicoB">Submit</button></div>

                                </form>
                            </div>
                            <div class="tab-pane fade" id="pills-medAs" role="tabpanel" aria-labelledby="pills-contact-tab">
                              <form id="alta_MedicoAs2">
