                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row toolbar">
                                    ...
                                    ?> 
                                    <a href="master.php?page=usuario/altaUsuario" title="Agregar Aseguradora">
                                        <button class="btn btn-primary"><span class="fa fa-plus fa-lg" style="color:#FFFFFF;"></span></button>
                                    </a>
                                    <?php 
                                }else if($_SESSION['rolUsuario']==2) {
                                    ?>
                                    <a href="admin.php?page=usuario/altaUsuario" title="Agregar Aseguradora">
                                        <button class="btn btn-primary"><span class="fa fa-plus fa-lg" style="color:#FFFFFF;"></span></button>
                                    </a>
                                    <?php
                                }else {
                            ...
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <?php include("controller/consultaUsuario.php");?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
