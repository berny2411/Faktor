                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Listado Aseguradora</li>
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row toolbar">
                            <div class="col-3">
                                <strong class="card-title">Listado Aseguradora</strong>
                            </div>
                            <div class="col-1">
                                <?php if ($_SESSION['rolUsuario']==1){
                                    ...
                                    ?>
                                    <a href="admin.php?page=aseguradora/registroAseguradora" title="Agregar Aseguradora">
                                        <button class="btn btn-primary"><span class="fa fa-plus fa-lg" style="color:#FFFFFF;"></span></button>
                                    </a>
                                    <?php
                                }else {
